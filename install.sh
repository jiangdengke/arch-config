...
link_file "$repo_root/environment.d/95-fcitx5.conf" "$HOME/.config/environment.d/95-fcitx5.conf"
...
link_file "$repo_root/applications/linuxqq.desktop" "$HOME/.local/share/applications/linuxqq.desktop"
